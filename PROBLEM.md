...
```bash
python main.py generate --algorithm=dfs --width=10 --height=10 --output=maze1.txt
python main.py generate --algorithm=prim --width=10 --height=10 --output=maze2.txt
python main.py solve --algorithm=astar --file=maze1.txt --start=0,0 --end=9,9 --output=solution_maze1.txt
python main.py solve --algorithm=dijkstra --file=maze2.txt --start=0,0 --end=9,9 --output=solution_maze2.txt
```
