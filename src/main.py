...
def main() -> None:
    ...
    parser.add_argument("task_type", type=str, help="Тип решаемой задачи", choices=['generate', 'solve'])
    ...
    parser.add_argument("--file", type=str, help="Файл с описанием лабиринта", default=None)
    ...
    parser.add_argument("--output", type=str, help="Путь для сохранения лабиринта", default=None)
